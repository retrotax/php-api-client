 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SignInResponse implements ArrayAccess
{
    /**
    ...
    {
        $this->container['username'] = isset($data['username']) ? $data['username'] : 'slade';
        $this->container['email'] = isset($data['email']) ? $data['email'] : 'username@example.com';
        $this->container['auth_token'] = isset($data['auth_token']) ? $data['auth_token'] : '7VHJh8K6lgdh157z';
    }
