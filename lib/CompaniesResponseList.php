...
/**
 * CompaniesResponseList Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     RetroTax
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CompaniesResponseList implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CompaniesResponse_list';
    ...
    {
        $this->container['fein'] = isset($data['fein']) ? $data['fein'] : null;
