...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-qa.retrotax-aci.com';
    ...
    {
        $report  = 'PHP SDK (RetroTax) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2016-12-19T14:06:08Z' . PHP_EOL;
