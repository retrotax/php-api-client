...
/**
 * TargetGroupsInner Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     RetroTax
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TargetGroupsInner implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TargetGroups_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['abbreviation'] = isset($data['abbreviation']) ? $data['abbreviation'] : 'DCR';
    }
    ...
    /**
     * Sets code
     * @param string $code TargetGroups code.
     * @return $this
     */
